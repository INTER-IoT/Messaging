    ...
    import eu.interiot.message.URI.URIManager;
...
//            jenaDataset.addNamedModel(messageConfig.getURImessageMetadataGraph(), metadata.getJenaModel());
        ...
        private void setJenaPrefixes() {
            //TODO: Test this in the context of prefix management
...
//        jenaDataset.getDefaultModel().setNsPrefix("rdf", "http://www.w3.org/1999/02/22-rdf-syntax-ns#");
            jenaDataset.getDefaultModel().setNsPrefix("InterIoTMsg", URIManagerMessageMetadata.PREFIX.InterIoTMsg);
            jenaDataset.getDefaultModel().setNsPrefix("InterIoT", URIManager.PREFIX.InterIoT);
