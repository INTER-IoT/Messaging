    ...
    import eu.interiot.message.metaTypes.ErrorMessageMetadata;
    import eu.interiot.message.metaTypes.PlatformMessageMetadata;
    import eu.interiot.message.metaTypes.QueryMetadata;
    import eu.interiot.message.metaTypes.SysInitMessageMetadata;
...
//                "platformId: " + printPlatformId() + "\n";
        ...
        public SysInitMessageMetadata asSysInitMessageMetadata() {
