 ...
 */
public class ProductPayloadFunctions extends MessagePayloadFunctions {

    /*
 Properties:

 */
    private static EntityID entityType = new EntityID("http://sweet.jpl.nasa.gov/2.3/reprMathOperation.owl#Product");

    public static EntityID getEntityType() {
        return entityType;
    }

    public void createProduct(MessagePayload payload, EntityID ProductID) {
        payload.getJenaModel().add(ProductID.getJenaResource(),
                RDF.type,
                entityType.getJenaResource());
    }

    public Set<EntityID> getProducts(MessagePayload payload) {
