 ...
 */
public class EnergyPayloadFunctions extends MessagePayloadFunctions {

    /*
 Properties:

 */
    private static EntityID entityType = new EntityID("http://inter-iot.eu/GOIoTPex#Energy");

    public static EntityID getEntityType() {
        return entityType;
    }

    public void createEnergy(MessagePayload payload, EntityID EnergyID) {
        payload.getJenaModel().add(EnergyID.getJenaResource(),
                RDF.type,
                entityType.getJenaResource());
    }

    public Set<EntityID> getEnergys(MessagePayload payload) {
