 ...
 */
public class ComplexUnitPayloadFunctions extends MessagePayloadFunctions {

    /*
 Properties:

 */
    private static EntityID entityType = new EntityID("http://sweet.jpl.nasa.gov/2.3/reprSciUnits.owl#ComplexUnit");

    public static EntityID getEntityType() {
        return entityType;
    }

    public void createComplexUnit(MessagePayload payload, EntityID ComplexUnitID) {
        payload.getJenaModel().add(ComplexUnitID.getJenaResource(),
                RDF.type,
                entityType.getJenaResource());
    }

    public Set<EntityID> getComplexUnits(MessagePayload payload) {
