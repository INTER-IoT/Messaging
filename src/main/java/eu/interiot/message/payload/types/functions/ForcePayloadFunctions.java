 ...
 */
public class ForcePayloadFunctions extends MessagePayloadFunctions {

    /*
 Properties:

 */
    private static EntityID entityType = new EntityID("http://inter-iot.eu/GOIoTPex#Force");

    public static EntityID getEntityType() {
        return entityType;
    }

    public void createForce(MessagePayload payload, EntityID ForceID) {
        payload.getJenaModel().add(ForceID.getJenaResource(),
                RDF.type,
                entityType.getJenaResource());
    }

    public Set<EntityID> getForces(MessagePayload payload) {
