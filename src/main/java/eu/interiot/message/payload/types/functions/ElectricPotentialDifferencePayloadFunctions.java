 ...
 */
public class ElectricPotentialDifferencePayloadFunctions extends MessagePayloadFunctions {

    /*
 Properties:

 */
    private static EntityID entityType = new EntityID("http://inter-iot.eu/GOIoTPex#ElectricPotentialDifference");

    public static EntityID getEntityType() {
        return entityType;
    }

    public void createElectricPotentialDifference(MessagePayload payload, EntityID ElectricPotentialDifferenceID) {
        payload.getJenaModel().add(ElectricPotentialDifferenceID.getJenaResource(),
                RDF.type,
                entityType.getJenaResource());
    }

    public Set<EntityID> getElectricPotentialDifferences(MessagePayload payload) {
