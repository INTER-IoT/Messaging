 ...
 */
public class SurfaceTensionPayloadFunctions extends MessagePayloadFunctions {

    /*
 Properties:

 */
    private static EntityID entityType = new EntityID("http://inter-iot.eu/GOIoTPex#SurfaceTension");

    public static EntityID getEntityType() {
        return entityType;
    }

    public void createSurfaceTension(MessagePayload payload, EntityID SurfaceTensionID) {
        payload.getJenaModel().add(SurfaceTensionID.getJenaResource(),
                RDF.type,
                entityType.getJenaResource());
    }

    public Set<EntityID> getSurfaceTensions(MessagePayload payload) {
