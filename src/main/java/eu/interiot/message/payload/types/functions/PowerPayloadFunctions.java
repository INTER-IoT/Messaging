 ...
 */
public class PowerPayloadFunctions extends MessagePayloadFunctions {

    /*
 Properties:

 */
    private static EntityID entityType = new EntityID("http://inter-iot.eu/GOIoTPex#Power");

    public static EntityID getEntityType() {
        return entityType;
    }

    public void createPower(MessagePayload payload, EntityID PowerID) {
        payload.getJenaModel().add(PowerID.getJenaResource(),
                RDF.type,
                entityType.getJenaResource());
    }

    public Set<EntityID> getPowers(MessagePayload payload) {
