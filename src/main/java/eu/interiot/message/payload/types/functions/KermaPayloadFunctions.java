 ...
 */
public class KermaPayloadFunctions extends MessagePayloadFunctions {

    /*
 Properties:

 */
    private static EntityID entityType = new EntityID("http://inter-iot.eu/GOIoTPex#Kerma");

    public static EntityID getEntityType() {
        return entityType;
    }

    public void createKerma(MessagePayload payload, EntityID KermaID) {
        payload.getJenaModel().add(KermaID.getJenaResource(),
                RDF.type,
                entityType.getJenaResource());
    }

    public Set<EntityID> getKermas(MessagePayload payload) {
