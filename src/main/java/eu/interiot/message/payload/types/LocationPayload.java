 ...
 */
public class LocationPayload extends TypedPayload {

    public LocationPayload() {
        this(false);
    }

    public LocationPayload(boolean useRDFSInferencer) {
        super(new EntityID("http://inter-iot.eu/GOIoTP#Location"), useRDFSInferencer);
    }

    public LocationPayload(Model jenaModel) {
        this(jenaModel, false);
    }

    public LocationPayload(Model jenaModel, boolean useRDFSInferencer) {
        super(new EntityID("http://inter-iot.eu/GOIoTP#Location"), jenaModel, useRDFSInferencer);
    }

    public void createLocation(EntityID LocationID) {
        createTypedEntity(LocationID);
    }
     ...
     */
    public Optional<String> getAsWKT(EntityID LocationID) {
     ...
     */
    public void setAsWKT(EntityID LocationID, String propertyValue) {
        removeAsWKT(LocationID);
        getJenaModel().add(
     ...
     */
    public void removeAsWKT(EntityID LocationID) {
