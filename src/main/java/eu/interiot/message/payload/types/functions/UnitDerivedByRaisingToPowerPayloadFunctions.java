 ...
 */
public class UnitDerivedByRaisingToPowerPayloadFunctions extends MessagePayloadFunctions {

    /*
 Properties:

 */
    private static EntityID entityType = new EntityID("http://sweet.jpl.nasa.gov/2.3/reprSciUnits.owl#UnitDerivedByRaisingToPower");

    public static EntityID getEntityType() {
        return entityType;
    }

    public void createUnitDerivedByRaisingToPower(MessagePayload payload, EntityID UnitDerivedByRaisingToPowerID) {
        payload.getJenaModel().add(UnitDerivedByRaisingToPowerID.getJenaResource(),
                RDF.type,
                entityType.getJenaResource());
    }

    public Set<EntityID> getUnitDerivedByRaisingToPowers(MessagePayload payload) {
