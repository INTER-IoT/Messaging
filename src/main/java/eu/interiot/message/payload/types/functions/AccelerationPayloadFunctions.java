 ...
 */
public class AccelerationPayloadFunctions extends MessagePayloadFunctions {

    /*
 Properties:

 */
    private static EntityID entityType = new EntityID("http://inter-iot.eu/GOIoTPex#Acceleration");

    public static EntityID getEntityType() {
        return entityType;
    }

    public void createAcceleration(MessagePayload payload, EntityID AccelerationID) {
        payload.getJenaModel().add(AccelerationID.getJenaResource(),
                RDF.type,
                entityType.getJenaResource());
    }

    public Set<EntityID> getAccelerations(MessagePayload payload) {
