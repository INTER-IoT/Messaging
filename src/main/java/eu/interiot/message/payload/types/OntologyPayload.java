 ...
 */
public class OntologyPayload extends TypedPayload {

    public OntologyPayload() {
        this(false);
    }

    public OntologyPayload(boolean useRDFSInferencer) {
        super(new EntityID("http://inter-iot.eu/GOIoTP#Ontology"), useRDFSInferencer);
    }

    public OntologyPayload(Model jenaModel) {
        this(jenaModel, false);
    }

    public OntologyPayload(Model jenaModel, boolean useRDFSInferencer) {
        super(new EntityID("http://inter-iot.eu/GOIoTP#Ontology"), jenaModel, useRDFSInferencer);
    }

    public void createOntology(EntityID OntologyID) {
        createTypedEntity(OntologyID);
    }

    public Set<EntityID> getOntologys() {
     ...
     */
    public Optional<String> getHasURI(EntityID OntologyID) {
     ...
     */
    public void setHasURI(EntityID OntologyID, String propertyValue) {
        removeHasURI(OntologyID);
        getJenaModel().add(
     ...
     */
    public void removeHasURI(EntityID OntologyID) {
     ...
     */
    public Optional<String> getHasVersion(EntityID OntologyID) {
        Set<Object> s = getJenaModel().listObjectsOfProperty(
                OntologyID.getJenaResource(),
     ...
     */
    public void setHasVersion(EntityID OntologyID, String propertyValue) {
        removeHasVersion(OntologyID);
        getJenaModel().add(
                getJenaModel().createLiteralStatement(OntologyID.getJenaResource(),
                        getJenaModel().createProperty("http://inter-iot.eu/GOIoTP#hasVersion"),
                        propertyValue
     ...
     */
    public void removeHasVersion(EntityID OntologyID) {
        getJenaModel().removeAll(OntologyID.getJenaResource(),
                getJenaModel().createProperty("http://inter-iot.eu/GOIoTP#hasVersion"),
                null);
    }
