 ...
 */
public class AreaPayloadFunctions extends MessagePayloadFunctions {

    /*
 Properties:

 */
    private static EntityID entityType = new EntityID("http://inter-iot.eu/GOIoTPex#Area");

    public static EntityID getEntityType() {
        return entityType;
    }

    public void createArea(MessagePayload payload, EntityID AreaID) {
        payload.getJenaModel().add(AreaID.getJenaResource(),
                RDF.type,
                entityType.getJenaResource());
    }

    public Set<EntityID> getAreas(MessagePayload payload) {
