 ...
 */
public class AngularAccelerationPayloadFunctions extends MessagePayloadFunctions {

    /*
 Properties:

 */
    private static EntityID entityType = new EntityID("http://inter-iot.eu/GOIoTPex#AngularAcceleration");

    public static EntityID getEntityType() {
        return entityType;
    }

    public void createAngularAcceleration(MessagePayload payload, EntityID AngularAccelerationID) {
        payload.getJenaModel().add(AngularAccelerationID.getJenaResource(),
                RDF.type,
                entityType.getJenaResource());
    }

    public Set<EntityID> getAngularAccelerations(MessagePayload payload) {
