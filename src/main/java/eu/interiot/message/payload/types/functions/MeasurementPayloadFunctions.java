 ...
 */
public class MeasurementPayloadFunctions extends MessagePayloadFunctions {

    /*
 Properties:

 */
    private static EntityID entityType = new EntityID("http://sweet.jpl.nasa.gov/2.3/repr.owl#Measurement");

    public static EntityID getEntityType() {
        return entityType;
    }

    public void createMeasurement(MessagePayload payload, EntityID MeasurementID) {
        payload.getJenaModel().add(MeasurementID.getJenaResource(),
                RDF.type,
                entityType.getJenaResource());
    }

    public Set<EntityID> getMeasurements(MessagePayload payload) {
