 ...
 */
public class UnitDerivedByScalingPayloadFunctions extends MessagePayloadFunctions {

    /*
 Properties:

 */
    private static EntityID entityType = new EntityID("http://sweet.jpl.nasa.gov/2.3/reprSciUnits.owl#UnitDerivedByScaling");

    public static EntityID getEntityType() {
        return entityType;
    }

    public void createUnitDerivedByScaling(MessagePayload payload, EntityID UnitDerivedByScalingID) {
        payload.getJenaModel().add(UnitDerivedByScalingID.getJenaResource(),
                RDF.type,
                entityType.getJenaResource());
    }

    public Set<EntityID> getUnitDerivedByScalings(MessagePayload payload) {
