 ...
 */
public class InputPayloadFunctions extends MessagePayloadFunctions {

    /*
 Properties:

 */
    private static EntityID entityType = new EntityID("http://www.w3.org/ns/ssn/Input");

    public static EntityID getEntityType() {
        return entityType;
    }

    public void createInput(MessagePayload payload, EntityID InputID) {
        payload.getJenaModel().add(InputID.getJenaResource(),
                RDF.type,
                entityType.getJenaResource());
    }

    public Set<EntityID> getInputs(MessagePayload payload) {
