 ...
 */
public class UnitDefinedByProductPayloadFunctions extends MessagePayloadFunctions {

    /*
 Properties:

 */
    private static EntityID entityType = new EntityID("http://sweet.jpl.nasa.gov/2.3/reprSciUnits.owl#UnitDefinedByProduct");

    public static EntityID getEntityType() {
        return entityType;
    }

    public void createUnitDefinedByProduct(MessagePayload payload, EntityID UnitDefinedByProductID) {
        payload.getJenaModel().add(UnitDefinedByProductID.getJenaResource(),
                RDF.type,
                entityType.getJenaResource());
    }

    public Set<EntityID> getUnitDefinedByProducts(MessagePayload payload) {
