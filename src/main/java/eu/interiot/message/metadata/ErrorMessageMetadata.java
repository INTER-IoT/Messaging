...
public class ErrorMessageMetadata extends MessageMetadata {
    ...
    /**
     * Creates a new {@code ErrorMessageMetadata} PlatformMessageMetadata from {@code MessageMetadata} MessageMetadata
    ...
    /**
     * Initializes the error code and description from a {@see MessageException}
     * See also {@see ErrorMessageMetadata#setErrorFromException(MessageException)} setErrorFromException}
     *
     * @param messageException See {@see MessageMetadata} constructor.
     */
    ...
    /**
     * Initializes the error code and description from a {@see MessageException MessageException}
     * See also {@see ErrorMessageMetadata#setErrorFromException(MessageException)} setErrorFromException}
     *
     * @param useRDFSInferencer Should inferencer be used.
     * @param messageException  See {@see MessageMetadata} constructor.
     */
    ...
    /**
     * Initializes the error code and description from a {@code MessageException MessageException}
     * See also {@code ErrorMessageMetadata#setErrorFromException(MessageException)} setErrorFromException}
     *
     * @param jenaModel        A model to be managed by this metadata.
     * @param messageException An exception that will be described by this metadata.
     * @throws MetadataException An exception is thrown, if the jena model is incorrect (see {@see MessageMetadata} constructor).
     */
