    ...
    public class IdentifierException extends PayloadException {

        private String code = ExceptionCodes.PAYLOAD_ID;
        ...
        protected IdentifierException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
